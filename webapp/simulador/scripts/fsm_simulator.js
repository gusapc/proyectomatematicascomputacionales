...
$("#startStop").click(function() {
  if ($("#startStop").text() === "Inicio") {
    var r = $("#inputString").val();
    $("#inputString").parent().html('<div id="inputString" type="text" class="input-div input-block-level monospaceRegex" placeholder="Aqui va la cadena a evaluar"><br></div>');
    ...
    $("#startStop").text("Detener");
  } else {
    var r = $("#inputString").text();
    $("#inputString").parent().html('<input id="inputString" type="text" class="input-block-level monospaceRegex" placeholder="Aqui va la cadena a evaluar">');
...
function onRegexOrAutomatonChange() {
  ...
  $("#inputPrevious").attr("disabled", true);
  $("#inputLast").attr("disabled", true);
  $("#inputString").parent().html('<input id="inputString" type="text" class="input-block-level monospaceRegex" placeholder="Aqui va la cadena a evaluar" disabled>');
